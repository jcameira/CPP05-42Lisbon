...
int main(void)
{
	...
	std::cout << "-------------------------------------------------------" << std::endl;
	{
		std::cout << std::endl;
		std::cout << "\033[34mConstructing\033[0m" << std::endl;
		Bureaucrat *a = new Bureaucrat( "Bureaucrat A", 1 );
		std::cout << std::endl;
		std::cout << "\033[34mTesting\033[0m" << std::endl;
		std::cout << a;
	...
	std::cout << "-------------------------------------------------------" << std::endl;
	{
		...
		try {
			a = new Bureaucrat( "Bureaucrat B", 0 );
		}
		catch( Bureaucrat::GradeTooHighException &e ) {
	...
	std::cout << "-------------------------------------------------------" << std::endl;
	{
		...
		try {
			a = new Bureaucrat( "Bureaucrat C", 160 );
		}
		catch( Bureaucrat::GradeTooLowException &e ) {
			std::cerr << "\033[33mConstructing default failed: " <<
			e.what() << "\033[0m" << std::endl;
	...
	std::cout << "-------------------------------------------------------" << std::endl;
	{
		std::cout << std::endl;
		std::cout << "\033[34mConstructing\033[0m" << std::endl;
		Bureaucrat *a = new Bureaucrat( "Bureaucrat D", 120 );
		std::cout << std::endl;
